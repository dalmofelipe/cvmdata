...
_CAD_HEADER = (
    "CNPJ_CIA;DENOM_SOCIAL;DENOM_COMERC;CD_CVM;SIT;DT_INI_SIT;TP_MERC;CATEG_REG;SETOR_ATIV;DT_INC"
)
...
def test_classify_unmapped_setor_low_confidence(db):
    _setup_classify_schema(db)
    _insert_raw(db, [{"CNPJ_CIA": "33.000.000/0001-33", "SIT": "ATIVO", "SETOR_ATIV": "Alimentos"}])
...
def test_classify_curation_events_not_duplicated_on_rerun(db):
    ...
    _setup_classify_schema(db)
    _insert_raw(db, [{"CNPJ_CIA": "33.333.333/0001-33", "SIT": "ATIVO", "SETOR_ATIV": "Alimentos"}])
