...
def test_run_full_reports_b3_tickers_step(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(orchestrator_module, "load_b3_tickers", lambda *args, **kwargs: 3)
    monkeypatch.setattr(
        orchestrator_module,
        "load_source_year",
    ...
    monkeypatch.setattr(orchestrator_module, "calculate_all", lambda *args, **kwargs: 7)
    monkeypatch.setattr(
        orchestrator_module,
        "download_info_cad",
    ...
    monkeypatch.setattr(orchestrator_module, "load_info_cad", lambda *args, **kwargs: 11)
    monkeypatch.setattr(
        orchestrator_module,
        "classify_info_cad",
